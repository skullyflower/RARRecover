export const stepsRarr = [
  ...
  "Came to believe that the Elder Gods, as we misunderstood them, could help us to pass unnoticed.",
  ...
  "Humbly surrendered our bloodlust to the Great Old Ones.",
  ...
  "Continued to keep track of our trail of destruction and, when we slipped up, made amends to the survivors.",
  "Sought through ritual and sacrifices to maintain a portal to R'lyeh to receive instructions.",
  "Having become an effective servant of the Elder Gods, we continued to only slaughter those deserving in the many eyes of the Great Old Ones.",
];

export const stepsAA = [
  "We admitted we were powerless over alcohol, and that our lives had become unmanageable.",
  "Came to believe that a Power Greater than us could restore us to sanity.",
  "Made a decision to turn our wills and our lives over to that Power as we understood it.",
