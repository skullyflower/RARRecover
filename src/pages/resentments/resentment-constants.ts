...
export const strings = { Angry: { title: "Anger is a weird thing.", intro: ["We feel that someone or something has wronged us. We feel they should be punished or stopped.", "And yet, most of the time, we do nothing but punish ourselves with our angry thoughts.", "It is we who suffer, not the wrong doer, from our anger."] }, Hurt: { title: "Feeling down?", intro: ["People can be hurtful whether they mean to be or not.", "You try and try, but they just won't listen to us, or treat us well.", "Or perhaps it's they themselves they abuse. Either way, you suffer."] } };